...
export default function NavigationBlue() {
    ...
    <>
      ...
      >
        <div className={`relative transition-all duration-300 rounded-2xl overflow-hidden ${isScrolled
          ...
          {/* Ambient Color Gradient - Blue theme */}
          <div className="absolute inset-0 bg-gradient-to-r from-blue-500/[0.03] via-transparent to-cyan-500/[0.03] pointer-events-none" />

          {/* Floating ambient orbs - Blue theme */}
          <div className="absolute -top-10 -left-10 w-32 h-32 bg-blue-500/[0.08] rounded-full blur-2xl pointer-events-none" />
          <div className="absolute -top-10 -right-10 w-32 h-32 bg-cyan-500/[0.06] rounded-full blur-2xl pointer-events-none" />
            ...
            <div className="flex items-center justify-between h-16 md:h-18">
              ...
              <div className="hidden lg:flex items-center gap-8">
                {navLinks.map((link, index) => (
                  <motion.a
                    key={link.label}
                    href={link.href}
                    className="text-base font-medium text-neutral-black hover:text-blue-500 transition-colors duration-200 relative group"
              ...
              >
                <a
                  ...
                  className="group px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-xl font-semibold text-base hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 hover:scale-[1.02] flex items-center gap-2 shadow-md shadow-blue-500/15"
                >
                  Find Freelancers
              ...
              <motion.button
                ...
                className="lg:hidden relative z-10 p-2 text-neutral-black hover:text-blue-500 transition-colors"
                whileTap={{ scale: 0.95 }}
                ...
                <div className="flex-1 px-6 py-8 space-y-6">
                  ...
                  <div className="space-y-2">
                    {navLinks.map((link, index) => (
                      <motion.a
                        key={link.label}
                        href={link.href}
                        className="w-full block text-left px-4 py-4 text-lg font-semibold text-neutral-black hover:text-blue-500 hover:bg-blue-500/5 rounded-brand-md transition-all duration-200"
                  ...
                  >
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full group px-6 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-xl font-semibold text-base hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 flex items-center justify-center gap-2 shadow-md shadow-blue-500/15"
                    >
                      Find Freelancers
                  ...
                  >
                    <p className="text-sm text-neutral-gray text-center leading-relaxed">
                      India's Platform for India's Buyers
                    </p>
                  </motion.div>
                </div>
              </div>
