...
const RotatingText3DBlue = dynamic(() => import('@/components/ui/rotating-text-3d-blue'), {
  ssr: false,
  loading: () => <div className="h-24 md:h-28 flex items-center justify-center"><span className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent text-3xl font-bold">Loading...</span></div>
})
