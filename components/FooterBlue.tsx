        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-white/70 mb-6 text-base leading-relaxed max-w-sm">
              India's Platform for Buyers. Find skilled freelancers through video portfolios. Browse by category & location. 100% free for buyers.
            </p>
            <div className="flex items-center gap-3">
              {socialLinks.map(({ Icon, href, label }) => (
                <a
                  ...
                  className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center hover:bg-blue-500 transition-all duration-300"
                  aria-label={label}
                >
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 text-white/70 hover:text-cyan-400 transition-colors duration-200 text-sm"
            >
