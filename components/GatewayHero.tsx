...
export default function GatewayHero() {
  return (
    <div className="min-h-screen min-h-[100dvh] overflow-hidden bg-gradient-to-b from-white via-orange-50/20 to-white flex flex-col">
      ...
      {/* Main Content */}
      <main className="flex-1 px-6 md:px-12 lg:px-20 flex flex-col justify-start md:justify-center overflow-hidden py-4 md:py-8">
        <div className="max-w-[1400px] mx-auto w-full">
          {/* Headline */}
          <div className="text-left mb-5 md:mb-10">
            <h1 className="text-2xl md:text-4xl lg:text-[42px] font-light text-gray-400 mb-0.5 md:mb-1 tracking-tight">
              One Platform. Two Sides.
            </h1>
            <h2 className="text-xl md:text-3xl lg:text-[38px] font-bold bg-gradient-to-r from-orange-500 via-orange-400 to-amber-500 bg-clip-text text-transparent tracking-tight leading-tight">
              Freelancers showcase. Buyers discover. Everyone wins.
            </h2>
          </div>

          {/* Two Cards Grid */}
          <div className="grid md:grid-cols-2 gap-4 md:gap-5 lg:gap-8">
            {/* Freelancer Card */}
            <Link
              href="/freelancers"
              className="group relative rounded-[24px] md:rounded-[28px] bg-gradient-to-br from-orange-500 via-orange-400 to-amber-400 p-5 md:p-8 h-[280px] md:h-[380px] lg:h-[420px] flex flex-col shadow-2xl shadow-orange-500/20 hover:shadow-orange-500/30 hover:scale-[1.02] transition-all duration-500 overflow-hidden"
            >
              ...
              <div className="relative z-10 flex-1">
                <p className="text-white/80 text-base md:text-xl font-normal mb-0.5 md:mb-1">
                  India's Platform for
                </p>
                <h3 className="text-white text-2xl md:text-4xl lg:text-[42px] font-bold mb-2 md:mb-3 leading-tight">
                ...
                {/* Avatar Stack */}
                <div className="flex items-center mt-4 md:mt-6 bg-white/20 backdrop-blur-sm rounded-full py-1.5 md:py-2 px-2.5 md:px-3 w-fit">
                  <div className="flex -space-x-2">
                    <div className="w-7 h-7 md:w-9 md:h-9 rounded-full border-2 border-white shadow-md overflow-hidden">
                    ...
                    <div className="w-7 h-7 md:w-9 md:h-9 rounded-full bg-orange-600 border-2 border-white shadow-md flex items-center justify-center">
                      <span className="text-white text-[8px] md:text-[10px] font-bold">+500</span>
                    </div>
                  </div>
                  <p className="ml-2 md:ml-3 text-white text-xs md:text-sm font-medium">
            ...
            <Link
              href="/buyers"
              className="group relative rounded-[24px] md:rounded-[28px] bg-gradient-to-br from-blue-500 via-blue-400 to-cyan-400 p-5 md:p-8 h-[280px] md:h-[380px] lg:h-[420px] flex flex-col shadow-2xl shadow-blue-500/20 hover:shadow-blue-500/30 hover:scale-[1.02] transition-all duration-500 overflow-hidden"
            >
              {/* Graphic Image - Background layer */}
              <div className="absolute right-0 bottom-0 w-[55%] md:w-[50%] h-[70%] md:h-[75%]">
                <Image
              ...
              <div className="relative z-10 flex-1">
                ...
                <div className="flex items-center mt-4 md:mt-6 bg-white/20 backdrop-blur-sm rounded-full py-1.5 md:py-2 px-2.5 md:px-3 w-fit">
                  <div className="flex -space-x-2">
                    ...
                    <div className="w-7 h-7 md:w-9 md:h-9 rounded-full bg-blue-600 border-2 border-white shadow-md flex items-center justify-center">
                      <span className="text-white text-[8px] md:text-[10px] font-bold">+500</span>
                    </div>
                  </div>
                  <p className="ml-2 md:ml-3 text-white text-xs md:text-sm font-medium">
      ...
      <div className="flex-shrink-0 px-6 md:px-12 lg:px-20 pb-2 md:pb-4">
